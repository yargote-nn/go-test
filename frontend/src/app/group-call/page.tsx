...
export default function GroupCall() {
	...
	return (
		<div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
			<h1 className="text-4xl font-bold mb-8">Group Call</h1>
			...
			<div className="grid grid-cols-2 gap-4">
				<div className="relative">
					<video
						...
						playsInline
						muted
						className="w-full h-auto border-4 border-blue-500 rounded"
					/>
				...
				{Object.entries(peerConnections).map(([peerId, { stream }]) => (
					<div key={peerId} className="relative">
						<video
							...
							autoPlay
							playsInline
							className="w-full h-auto border-4 border-green-500 rounded"
						>
							<track kind="captions" />
						</video>
