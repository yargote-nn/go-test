				...
				<CardContent className="flex flex-col items-center gap-4 p-6">
					<div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
						<Input
							...
							className="w-full max-w-lg shadow-inner"
							disabled={isInRoom}
							aria-label="Room ID"
						/>
						{!isInRoom ? (
							<Button
								onClick={joinRoom}
								className="w-full max-w-xs hover:scale-105 hover:transition-all sm:w-auto"
							>
					...
					{localStreamRef.current && (
						<div className="relative flex max-w-sm items-center justify-center overflow-hidden rounded-lg shadow-lg">
							<video
								ref={(el) => {
